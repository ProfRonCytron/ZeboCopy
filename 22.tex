...
\visible<1->{U_f\left(\TensProd{\RootTwoN{n}\sum_{x\in \Set{0,1}^{n}}\ket{x}}{\ket{-}}\right)}\visible<2->{ &=
\RootTwoN{n}\sum_{x\in \Set{0,1}^{n}} U_f(\ket{x\,-}) \\}
\visible<3->{&= \RootTwoN{n} \sum_{x\in \Set{0,1}^{n}}\TensProd{\NegF{x}\ket{x}}{\ket{-}}}
\end{align*}
\begin{itemize}
