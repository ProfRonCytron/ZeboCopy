...
\begin{itemize}
    ...
    \[
    \cos(\ColorFour{\theta}/2)\ket{+} + \sin(\ColorFour{\theta}/2)\ket{-}
    \]
    \item<21-> So we measure \ket{+} with probability $\cos^{2}(\ColorFour{\theta}/2)$ and \ket{-} with probability $\sin^{2}(\ColorFour{\theta}/2)$.
