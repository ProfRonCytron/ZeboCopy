...
\only<4,6>{%
\Vskip{-3em}\begin{center}
\begin{Pixture}[width=0.6\textwidth]{00}{einstein.jpeg}
\end{Pixture}\end{center}}%
\only<7->{%
\Vskip{-3em}\begin{center}
\begin{Pixture}[width=0.6\textwidth]{00}{merge.jpeg}
\end{Pixture}\end{center}}
}
...
\only<1>{%
\begin{center}
\begin{Pixture}[width=0.7\textwidth]{00}{qc1.png}    
\end{Pixture}\end{center}
}%
\only<2>{%
\begin{center}
\begin{Pixture}[width=0.7\textwidth]{00}{qc2.png}    
\end{Pixture}\end{center}}%
\only<3>{%
\begin{center}
\begin{Pixture}[width=0.7\textwidth]{00}{joke.jpeg}    
\end{Pixture}\end{center}
}
\end{frame}
...
\begin{Pixture}[width=0.75\textwidth]{00}{qise.png}
\end{Pixture}\end{center}%
\end{frame}
