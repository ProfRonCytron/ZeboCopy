...
\begin{itemize}
    ...
    \begin{description}
        ...
        \begin{itemize}
            ...
            \item \ColorOne{Minor in Quantum Engineering}
            \item \ColorTwo{Graduate certificate in Quantum Engineering}
        \end{itemize}
        \item [Math]
        \begin{itemize}
...
\begin{frame}{Physics theories}{What should they do for us?}
\begin{description}
    \item[predict outcomes]  Perhaps a physics theory suffices when it adequately predicts the results of experiments.  
    \begin{itemize}
        \item \href{https://physicstoday.scitation.org/doi/10.1063/1.1768652}{Shut up and calculate!}
        \item Perhaps not \LinkArrow{https://aeon.co/essays/shut-up-and-calculate-does-a-disservice-to-quantum-mechanics}
    \end{itemize}
    \item[explain how things work]  Perhaps a physics theory should shed light on \emph{how} things work.
    \begin{itemize}
