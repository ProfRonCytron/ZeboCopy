...
\begin{align*}
    ...
    \visible<7->{\QState{3} =& \TensProd{\TensSupProd{\Hadamard}{n}\left(\textcolor<8->{\RCthree}{\SumBV{x}{n} \NegOneExp{\DotP{x}{s}} \ket{x}}\right)}{\ket{-}}} \visible<8->{= \TensProd{\TensSupProd{\Hadamard}{n}(\textcolor<8->{\RCthree}{\TensSupProd{\Hadamard}{n}(\ket{s})})}{\ket{-}} }\visible<9->{= \TensProd{\textcolor<9>{\RCthree}{\alert<10>{\ket{s}}}}{\ket{-}}}
\end{align*}
