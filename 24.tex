...
\begin{itemize}
    ...
    \item<9-> These partial measurements don't help:  Sampling the top qubits will yield \ket{000} or \ket{101}.
    \item<10-> Running the circuit again will yield a random measurement on the bottom qubits!
\end{itemize}}
}
