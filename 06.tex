...
\begin{itemize}
    ...
    \item<8-> The \PauliZ{} matrix corresponds to the \href{https://en.wikipedia.org/wiki/Qubit\#Standard_representation}{computational basis}, because its eigenvectors are \ket{0} \visible<9->{and \ket{1}.}
\end{itemize}
}{%
\only<8-9>{%
\begin{align*}
    \ZMatrix{} \PZero{} & = & +1  & \PZero{} \\
    \visible<9->{\ZMatrix{}  \POne{} & = & -1  & \POne{}}
\end{align*}}
\begin{center}
\begin{TIKZP}
\visible<8->{
