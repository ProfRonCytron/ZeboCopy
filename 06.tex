...
\visible<1->{\begin{scope}[draw=NavyBlue,rotate=90]\PFilter{-1}{-1.2}{1}{1.2}{20}\end{scope}}
...
\begin{itemize}
  ...
  \item<4-> From the picture, \textcolor{OrangeRed}{$\phi$} doesn't matter when $\textcolor{NavyBlue}{\theta}=\pi$.  How can this be?
\end{itemize}
}{%
\only<1-4>{%
\[ \ket{\psi} = \Bloch{\theta}{\phi} \]}
...
\only<5>{%
\begin{itemize}
\item With $0$ as the amplitude on \ket{0}, any phase on \ket{1} with $\textcolor{OrangeRed}{\phi}\not=0$ can be canceled with an appropriate global phase of 
