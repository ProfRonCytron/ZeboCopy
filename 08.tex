...
\begin{frame}{Proof}{We begin with an arbitrary unitary matrix $U$.}
\TwoColumns{%
...
\begin{itemize}
\item Each column of $U$ (row of \Conj{U}) is \href{https://en.wikipedia.org/wiki/Orthonormality}{orthonormal}:
\begin{align*}
    \Conj{a}a + \Conj{c}c = & \Prob{a} + \Prob{c} = 1 \\
    \Conj{b}b + \Conj{d}d = & \Prob{b} + \Prob{d} = 1 
\end{align*}
\item $\Implies{\Prob{a} + \Prob{c} = 1}{\Mag{a} \leq 1}$
\end{itemize}
}{%
...
\begin{align*}
    ...
    \Conj{b}b + \Conj{d}d = & \Prob{b} + \Prob{d} = 1 
\end{align*}
\item Each row of $U$ (column of \Conj{U}) is orthonormal:
\begin{align*}
    \Prob{a} + \Prob{b} = & 1 \\
    \Prob{c} + \Prob{d} = & 1
\end{align*}
