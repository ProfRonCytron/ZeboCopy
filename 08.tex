...
\Vskip{-3em}\[
    ...
    \begin{align*}
    U&= 
    \SQBG{\phantom{\ExpPhase{\phi_a}}}{\textcolor{Black}{\ExpPhase{\phi_{a}}\cos(\theta/2)}}{\textcolor{Black}{\ExpPhase{\phi_{b}}\sin(\theta/2)}}{\textcolor{Black}{\ExpPhase{\phi_{c}}\sin(\theta/2)}}{\textcolor{Black}{\ExpPhase{((\phi_{b}+\pi) + \phi_{c}-\phi_{a})}\cos(\theta/2)}} \\
    &= \SQBG{\ExpPhase{\phi_a}}{\textcolor{Black}{\ExpPhase{\phi_{a}}\cos(\theta/2)}}{\textcolor{Black}{\ExpPhase{\phi_{b}}\sin(\theta/2)}}{\textcolor{Black}{\ExpPhase{\phi_{c}}\sin(\theta/2)}}{\textcolor{Black}{\ExpPhase{((\phi_{b}+\pi) + \phi_{c}-\phi_{a})}\cos(\theta/2)}}
    \end{align*}
