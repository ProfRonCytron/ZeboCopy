...
\Vskip{-3em}\TwoUnequalColumns{0.5\hsize}{0.5\hsize}{%
    ...
    \begin{itemize}
        ...
        \item The photon is measured after passing through the first beam splitter.  From there it reaches either the \textcolor{orange}{orange} sensor or the \textcolor{\RCtwo}{blue} sensor.
    \end{itemize}
    \end{itemize}
    }%
    \only<3-4>{%
    ...
    \begin{tabular}{lc}
       ...
       \textcolor{orange}{Orange sensor} & 25\% \\
...
\only<5>{Recall that without the obstruction, all photons are measured only at the \textcolor{orange}{orange sensor}.}
\only<6->{%
