...
\LeaveSpace{}
    ...
    \item \Points{15} Consider the oracle portion of a circuit below for an $8$-bit instance of the Bernstein--Vazirani problem.  Recall the oracle computes $y=\DotP{x}{s}$ for a secret bit vector~$s$.
 \begin{center}   
