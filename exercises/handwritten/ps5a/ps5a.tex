...
\begin{enumerate}[font=\bfseries]
    ...
    \item In that state, suppose Bob is assigned column~1.  What two outcomes might he see for his \textbf{Z} (first qubit) measurement?
    
    \Blank{} or \Blank{}
    \item And what two outcomes might he see for his \textbf{X} (second qubit) measurement?
    
    \Blank{} or \Blank{}
    
    \item Assuming Bob sees the first of your responses in the above two questions, what result ($\pm 1$) does Bob report for his
    \begin{itemize}
