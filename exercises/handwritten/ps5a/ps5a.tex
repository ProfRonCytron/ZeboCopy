...
\begin{enumerate}[font=\bfseries]
    ...
    \item (2 points) Are all combinations of outcomes possible?  \Blank{}.  If not below say which are possible
    
    \Blank[2in]{}
    \item (2 points) Referring to Slide 14, what two possible states ($\psi_{?}$ or $\psi_{?}$) could Bob see when he measures after Alice?
    
    \Blank{} or \Blank{}
    \item (3 points) Assuming Bob measures $\ket{0}$ for his first quit and $\ket{+}$ for his second qubit, what results ($\pm 1$) does Bob report for his
    \begin{itemize}
