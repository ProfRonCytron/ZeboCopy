...
\begin{enumerate}[font=\bfseries]
    ...
    \item (25 points) Consider the quantum states
        ...
        \end{enumerate}
    \item (Bonus, up to 3 points) Write one interesting question related to the content of this homework, and indicate the correct answer. The question can be multiple-choice format.  Interesting questions get credit here;  sufficiently good questions might appear on an exam.
\end{enumerate}
