...
\item 
    ...
    \begin{enumerate}[label=\theenumi.\arabic*]
    \item Let's construct the Controlled-\PauliZ{} (\NamedGate{CZ}) gate based on what it does to the computational basis vectors, expressed not as column vectors but as tensor products:
    \begin{itemize}
