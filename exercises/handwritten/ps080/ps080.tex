...
\item 
    ...
    \item (3 points) Under what circumstances must we perform the tensor product of two gates before applying them to a quantum state, as compared with applying each gate separately to its incoming qubit?
    \LeaveSpace{}
