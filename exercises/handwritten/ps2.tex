...
\begin{enumerate}[font=\bfseries]
    ...
    \item Consider the quantum states
        ...
        \begin{enumerate}
            ...
            \item More generally, what do the columns of such as 2 × 2 matrix (such as $U$) represent with respect to their inputs in the standard basis ($\ket{0}$ and $\ket{1}$)?
        \end{enumerate}
    \item Throw in exponentiation of matrices proof here depending on time
\end{enumerate}
