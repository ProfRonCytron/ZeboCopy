...
\begin{enumerate}[font=\bfseries]
    ...
    \LeaveSpace[2.0in]
    \item (5 points) Can the controlled $\mathbf{Z}$ gate matrix be written as the tensor product of two matrices? Prove or disprove. \LeaveSpace[2.5in]    \item (15 points) Consider standard quantum teleportation. Imagine Alice has the incredible power to transmit exactly one bit to Bob instantaneously (faster than the speed of light whoa). Let's investigate how this changes Bob's situation.
    \begin{enumerate}
