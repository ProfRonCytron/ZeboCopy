...
\begin{itemize}
    ...
    \item<2-> The two unaffected states are \ket{+y} and \ket{-y}. \Exercise{unaffected points}{Show that Paul Y doesn't affect +y or -y.}
    \item<3-> This gate maps $\ket{0}\mapsto\ket{1}$ and \VV{}.
\end{itemize}
}{%
\begin{center}
...
\begin{itemize}
    ...
    \end{tabular}}
    \end{center}
    \item Each matrix has \href{https://en.wikipedia.org/wiki/Eigenvalues_and_eigenvectors}{eigenvalues} $\pm 1$.  \Exercise{Pauli eigenvectors}{Compute the eigenvalues and eigenvectors of each Pauli matrix.}
\end{itemize}
\end{frame}
