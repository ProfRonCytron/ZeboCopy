...
\only<7->{%
The axes on the Bloch Sphere are often used in physics to model spin in each of the three physical dimensions.  In quantum computing we almost exclusively use the standard basis of \ket{0} and \ket{1}.
}
}{%
\[ \ket{\psi} = \Bloch{\theta}{\phi} \]
\begin{BlochSphere}[scale=1.5]{60}{115}
...
\begin{itemize}
    ...
    \item We can express any state using any basis (linear algebra).
\end{itemize}
}{%
\begin{center}
\begin{BlochSphere}[scale=1.5]{60}{115}
