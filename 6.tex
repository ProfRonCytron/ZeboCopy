\SetTitle{6}{A single qubit}{Representation and some quantum gates}{introqsys}
...
\end{align*}
\alert<4>{Given a state with real amplitudes ($\phi=0$ on the Bloch sphere), this rotation shifts probability between \ket{0} and \ket{1} while keeping the amplitudes real.}
\end{frame}
...
\begin{itemize}
    ...
    \item We have studied three gates of interest so far:
    \begin{itemize}
        \item The Hadamard gate creates a uniform superposition of \ket{0} and \ket{1} given the input \ket{1}.
