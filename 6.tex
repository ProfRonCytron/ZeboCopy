...
\]
\begin{itemize}
    \item<1-> This transformation exchanges the amplitudes and rotates the components $\pi$ radians from each other: \[ \ApplyGate{\PauliY}{\SQB{\alpha}{\beta}} \mapsto  \SQB{-i\beta}{i\alpha} \]
