...
\begin{BlochSphere}[scale=2.5]
    \TZPoint{0,0,1}{\ket{0}}{above right}
    \TZPoint{0,0,-1}{\ket{1}}{below right}
    
    \tdplotsetrotatedcoords{0}{0}{0};
    \draw[tdplot_rotated_coords, orange, ultra thick] (1.0,0,0) arc (0:45:1.0) node(phi) {};
    \draw[tdplot_rotated_coords,->,orange,ultra thick] (0,0,0) -- (phi);
