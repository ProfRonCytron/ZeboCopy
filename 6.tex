...
\def\Bloch#1#2{%
\cos{\frac{#1}{2}}\ket{0} + \Polar{}{#2}\sin{\frac{#1}{2}}\ket{1}}
...
\[ \Bloch{\theta}{\phi} \]
\begin{itemize}
    \item The parameter $\theta$ balances wave amplitude between \ket{0} and \ket{1}.
    \item We recall it's the relative phase between \ket{0} and \ket{1} that matters.  The relative phase difference is placed on \ket{1}, using a walk of $\phi$ radians counterclockwise around the complex unit circle, starting at 0~radians.
