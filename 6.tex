...
\begin{itemize}
    ...
    \item<2-> How?  We need a transformation (unitary matrix) \Hadamard{} that sends $\ket{0}\mapsto \ket{+}$ and $\ket{1}\mapsto \ket{-}$.
    \item<3-> From linear algebra, the columns of \Hadamard{} are transformed versions of \textcolor<4->{NavyBlue}{\ket{0}} and \textcolor<5->{OliveGreen}{\ket{1}}.
    \item<6-> \Hadamard{} is also its own inverse.
