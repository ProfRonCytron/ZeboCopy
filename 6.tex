...
\begin{frame}{Pauli \PauliY{}}{Exchanges amplitudes and imposes phase}
...
\end{center}
\PauliY{} generally
rotates a state  by $\pi$ radians around the y~axis.  This gate also maps $\ket{+} \mapsto \ket{-}$ and \VV{}.
}
\end{frame}
