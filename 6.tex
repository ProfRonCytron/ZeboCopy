...
\begin{align*}
R_{x}(\theta) = & \ExpNegPhase{\left(\frac{\theta}{2}\right)\,\PauliX{}}  \visible<2-3>{= \EulerP{\PauliX{}}}
...
R_{y}(\theta) = & \ExpNegPhase{\left(\frac{\theta}{2}\right)\,\PauliY{}}\visible<2-3>{= \EulerP{\PauliY{}}}\\[0.7em]
R_{z}(\theta) = & \ExpNegPhase{\left(\frac{\theta}{2}\right)\,\PauliZ{}} \visible<2-3>{= \EulerP{\PauliZ{}}}
\end{align*}
\end{frame}