...
\begin{itemize}
    ...
    \item<7-> Finally, knowing $\ColorTwo{w_2}$ and $\ColorThree{w_3}$, we can rotate $.\ColorOne{w_1}\ColorTwo{w_2}\ColorThree{w_3}$ to obtain
...
\begin{itemize}
    ...
    \item<5-> Because we already know $\ColorThree{w_3}$ we can take action to rotate the state to obtain $.\ColorTwo{w_2}0$, clearing the second bit if necessary (it is!).
