...
\begin{frame}{Circuit from the perspective of qubit $k$}{General solution for $n$ quvbits}
...
{\Large
\begin{align*}
    v =& \ExpPhase{2\pi (\LBP{}w_{1}w_{2}\cdots \ColorOne{1}0\cdots 0)} \\
    v \times z =&
    \ExpPhase{2\pi (\LBP{}w_{1}w_{2}\cdots \ColorOne{1}0\cdots 0)}\times \ExpNegPhase{2\pi(\LBP{}00\cdots\ColorOne{1}0\cdots0)} \\
    =& \ExpPhase{2\pi(\LBP{}00\cdots\ColorOne{1}0\cdots 0\ -\  \LBP{}00\cdots\ColorOne{1}0\cdots0)} \\
    =& \ExpPhase{2\pi(\LBP{}00\cdots\ColorOne{0}0\cdots 0)}\\
    z =& \ExpNegPhase{2\pi\frac{1}{2^{\ColorOne{k}}}}
\end{align*}
}
