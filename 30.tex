...
\begin{itemize}
    ...
    \item<12-> Rotate away \ColorThree{$w_3$}
...
\begin{itemize}
    ...
    \item<17-> Rotate away \ColorThree{$w_3$}
    \item<19-> No need to rotate away \ColorTwo{$w_2$}=\ColorTwo{$0$}
...
\visible<1-4,8-19>{\ColorTwo{w_{2}}}\visible<3-7>{\LBP{}}
\visible<1-12,16-17>{\ColorThree{w_{3}}}
=
\visible<1->{\LBP{}}
\visible<22->{\ColorOne{1}}\visible<20>{\LBP{}}
\visible<15->{\ColorTwo{0}}\visible<20>{\LBP{}}
