...
{
\def\T#1{\TwoSupOp{\ket{0}}{\ExpPhase{2\pi\left(2^{#1}w\right)}\ket{1}}{+}}
\begin{frame}{Useful theorem}{Needed for phase estimation}
\begin{itemize}
    \item We state the theorem here and prove it later.
    \item This theorem allows us to view a periodic state qubit-by-qubit, due to the tensor factoring.
\end{itemize}

\begin{align*}
 \RootTwoN{n}\SumPH{y}{n} \ExpPhase{2\pi wy} \ket{y} =& \T{n-1}  \\
 \TensOp{} & \T{n-2} \\
 \TensOp{} & \cdots \\
 \TensOp{} & \T{n-n} 
\end{align*}
