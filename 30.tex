...
\begin{align*}
    \ket{+} &= \QPlus{} \\
        ...
        \visible<4->{    &= \RootTwoN{1}\SumPH{y}{1} \ExpPhase{2\pi\cdot 0\cdot y} \ket{y}}
\end{align*}
}{%
\begin{align*}
    \ket{-} &= \QMinus{} \\
           \visible<5->{ &=  \RootTwoN{1}\left(\ColorOne{\ExpPhase{0}}\QZero{} \visible<6->{- \ColorTwo{\ExpPhase{0}}\QOne{}}\right) \\}
        \visible<7->{    &= \RootTwoN{1}\SumPH{y}{1} \ExpPhase{2\pi\cdot \frac{1}{2}\cdot y} \ket{y}}
\end{align*}
}
\Vskip{-4em}\TwoColumns{%
\begin{center}
\adjustbox{valign=t, width=0.5\textwidth}{\begin{TIKZP}
\UnitComplexCircle{}
  \visible<2->{
