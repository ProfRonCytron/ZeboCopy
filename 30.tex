...
Challenge:
\begin{itemize}
  \item Can an approach be formulated that estimates phase while preserving the input qubits' state(s)?
  \item If so, what is that appraoch;  if not, why is this impossible?
\end{itemize}
}
