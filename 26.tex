...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      \item The amplitudes for all other \ket{x} become slightly smaller.
    \end{itemize}
\end{itemize}
}
\end{frame}
...
\begin{frame}{Values for $n=5$ bits}{Using \href{https://docs.google.com/spreadsheets/d/1JCp9PKLTQ7q9jdvRwj-gXxL9jYvu1O-1wA2OnnEBB3s/edit?usp=sharing}{this} Google sheet}

\Vskip{-4em}\begin{center}
\begin{Pixture}[width=0.6\textwidth]{26}{5bitGrover.png}
\end{Pixture}
\end{center}
\begin{itemize}
    \item \A{} increases linearly, but at some point \B{} becomes negative, diminishing \A{}.
