...
\begin{frame}{Examples}{Cryptographic and \href{https://complexityzoo.net/Complexity_Zoo:N\#npc}{\CompClass{NPC}}}

\TwoColumns{%
RSA
\begin{itemize}
    \item Consider two large primes $p$ and $q$ whose products are $r$.
    \item Let $x$ have $n$ qubits, sufficient to encode $p$ and $q$: \[n=\Theta(\log{p}+\log{q})=\log{pq}\]
