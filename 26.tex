...
\begin{TIKZP}[scale=3]
    \visible<1->{\draw[->,thick,\RCone] (0,0) -- (7:1) node[right]{\S};} \visible<2->{\draw[->,thick,\RCthree] (0,0) -- (0,1) node[above]{\W} ;}
...
\item This is accomplished using the familiar phase-kickback trick.
\end{itemize}
}
}{%
...
\begin{TIKZP}[scale=2.5]
    ...
    \visible<2->{\draw[->,thick,\RCthree] (0,0) -- (0,1) node[above right]{$\W=\CDQB{0}{0}{1}{0}$} ;}
