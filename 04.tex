...
\begin{center}
\begin{TIKZP}
\visible<1-3>{\begin{scope}[draw=NavyBlue,rotate=90]\PFilter{-1}{-1.2}{1}{1.2}{20}\end{scope}
\draw[->,thick] (0,0) -- (1,0) ;
}
\visible<2>{\begin{scope}[draw=OliveGreen]\PFilter{-1}{-1.2}{1}{1.2}{20}\end{scope}
\draw[->,thick] (0,0) -- (1,0) ;
\draw[->,thick] (0,0) -- (0,1);
}
