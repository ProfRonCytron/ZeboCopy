\SetTitle{24}{The Bernstein--Vazirani problem}{Another use of phase kickback}{24}
...
\Vskip{-4em}\TwoUnequalColumns{0.47\textwidth}{0.53\textwidth}{%
\begin{center}
...
\lstick{\QZero{}} & \gate{\PauliX} &   \gate{\Hadamard}   &  \qw\gateinput{$y$}\gateoutput{\Xor{y}{f(x)}} & \qw & 
\end{quantikz}}
\end{center}
\begin{Reasoning}
...
\Reason{7}{Dropping the bottom qubit for \QState{3}}%
...
\visible<2->{\QState{1} =& \RootTwoN{n}\TensProd{\SumBV{x}{n} \ket{x}}{\ket{-}} \\}
\visible<3->{\alert<8>{\TensSupProd{\Hadamard}{n}(\ket{s}) =}& \alert<8>{\RootTwoN{n}\SumBV{x}{n} \NegOneExp{\DotP{x}{s}} \ket{x}} \\}
\visible<4->{\alert<9>{\TensSupProd{\Hadamard}{n}(\TensSupProd{\Hadamard}{n}(\ket{s})) =}& \alert<9>{\ket{s}}}
\end{align*}
}
\begin{align*}
    \visible<5->{\QState{2} =& \RootTwoN{n}\TensProd{\SumBV{x}{n} \NegF{x} \ket{x}}{\ket{-}}} 
               \visible<6->{= \RootTwoN{n}\TensProd{\SumBV{x}{n} \NegOneExp{\DotP{x}{s}} \ket{x}}{\ket{-}} \\}
    \visible<7->{\QState{3} =& \TensSupProd{\Hadamard}{n}\left(\textcolor<8->{\RCthree}{\RootTwoN{n}\SumBV{x}{n} \NegOneExp{\DotP{x}{s}} \ket{x}}\right)} \visible<8->{= \TensSupProd{\Hadamard}{n}(\textcolor<8->{\RCthree}{\TensSupProd{\Hadamard}{n}(\ket{s})}) }\visible<9->{= \textcolor<9>{\RCthree}{\alert<10>{\ket{s}}}}
\end{align*}
    
\end{frame}

\begin{frame}{Extra material about this on the board}{No slides yet}
