...
Outer products can be used to define a matrix based on where it sends basis vectors.  For example, suppose we want to build a quantum \emph{not} gate (Pauli \PauliX).  We want the following behavior:
\begin{itemize}
