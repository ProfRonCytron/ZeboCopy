...
\begin{enumerate}
    \item<1-> \SQB{1}{0}
    \item<2-> \SQB{0}{1}
    \item<3-> \SQB{\RootTwo}{\RootTwo}
    or \SQB{-\RootTwo}{\RootTwo}
    or \SQB{\RootTwo}{-\RootTwo}
    \item<4-> \DQB{\RootN{3}}{\RootN{6}}{\RootN{6}}{-\RootN{3}}
\end{enumerate}
}{%
\begin{enumerate}
    ...
    \item<3-> \QZero{} and \QOne{} each occurs with probability ${\left(\RootTwo\right)}^2=\frac{1}{2}$
