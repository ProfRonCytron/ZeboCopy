...
\begin{frame}{Overview of the approach}{We review some background first}

\begin{itemize}
    \item We consider a system of $n$ qubits.
    \item We find $2^n$ orthonormal eigenstates in our desired basis.
    \item We form a matrix $T$ whose columns are the eigenstates.  The matrix must be unitary:
    \begin{itemize}
...
\begin{frame}{Measurement operators}{Review of the computational basis}

\begin{itemize}
    \item An operator representing measurement outcomes in some basis must have the following properties.
\end{itemize}
...
\begin{frame}{Mapping from other bases}
\end{frame}

\begin{frame}{Example 1}{The computational basis for two qubits}
...
\Vskip{-3em}\begin{itemize}
    ...
    \begin{center}
        ...
        \ket{11} & $+1$
         \end{tabular}
    \end{center}
    \item The resulting matrix $T$ is shown to the right, and it is of course its own inverse.
