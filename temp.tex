...
\ScrollProof{21}{22}{%
\Next{\Two}{\CQB{\AC}{\BC}\times\SQB{\BConj}{\MAC}&=0 \\}
\Next{\One}{\CQB{\A}{\BConj}\times\SQB{\BC}{\MA}&=0}
}
}
}{%
\[
...
\Reason{21}{Inner product of rows}%
\Reason{22}{Inner product of columns}%
\end{Reasoning}
}
}
}
