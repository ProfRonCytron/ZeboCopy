...
\Reason{24}{$\Implies{N\geq 4}{\sqrt{3N-3}-1 \geq \sqrt{N}}$}
\end{Reasoning}
\ScrollProof{1}{5}{%
...
\ScrollProof{23}{25}{%
\Next{\Four}{\mu_{i} &\geq \frac{1}{2}\frac{\sqrt{3N-3}-1}{N}\\}
\Next{\Three}{& \geq \frac{1}{2}\frac{\sqrt{N}}{N} \\}
\Next{\Two}{& \geq \frac{1}{2}\RootN{N}}
}
\end{frame}
}