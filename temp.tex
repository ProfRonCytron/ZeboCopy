...
\begin{itemize}
    ...
    \item We apply transformations to $U$, each of which operates only on 2~qubits at a time, to reduce $U$ \ColorTwo{to a form} where it also operates only on $2$~qubits.
\end{itemize}
}{%
