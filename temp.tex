...
\end{theorem}
\begin{Reasoning}
\Reason{1}{Outcome probabilities sum to 1}
\end{Reasoning}
\ScrollProof{1}{5}{%
\Next{\Four}{\Prob{\A_{i}} + (N-1)\Prob{\B_{i}} &= 1\\}
\Next{\Three}{\Prob{\A_{i}}  &= 1 -(N-1)\Prob{\B_{i}} \\}
\Next{\Two}{\frac{1}{2} \geq \Prob{\A_{i}}  &= 1 -(N-1)\Prob{\B_{i}} \\}
\Last{\frac{1}{2} & \geq 1 -(N-1)\Prob{\B_{i}} \\}
}%
\ScrollProof{6}{10}{%
\Next{\Four}{\frac{1}{2} & \geq 1 -(N-1)\Prob{\B_{i}} \\}
\Next{\Three}{(N-1)\Prob{\B_{i}} & \geq 1-\frac{1}{2}\\}
}
