...
\Next{\Three}{2\mu_{i}+\A_{i} &= \frac{2(N-1)\B_{i} -2\A_{i}}{N} + \frac{N\A_{i}}{N}\\}
...
\end{frame}
\begin{frame}{Theorem: \A{} increases each iteration by at least \RootN{N}}{If it is not already too large, and we have a reasonably large problem to solve}
\begin{theorem}
