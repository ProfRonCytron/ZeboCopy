...
\Reason{15}{Introduce \ColorBlack{an indexing variable}}
\Reason{18}{Express the \ColorBlack{index variable} as a \ColorBlack{summation}}
\Reason{19}{Switch the order of the summations}
\Reason{22}{Express \ColorBlack{$z$} and \ColorOne{$y$} as \ColorBlack{v}}
\end{Reasoning}
{\small
\ScrollProof{1}{4}{%
