...
\gdef\CarrySix{\RootTwoN{k}\ColorOne{\SumBV{y}{k-1}}\SumBV{z}{1} \ExpPhase{2\pi w (z\times2^{k-1}+y)}\ket{z\ColorOne{y}}}
\Last{ &=  \CarrySix}
}%
\ScrollProof{17}{20}{%
\Next{\Four}{\TT{k} &= \CarrySix\\}
\Next{\Three}{&= \RootTwoN{k}\SumBV{z}{1}\ColorOne{\SumBV{y}{k-1}} \ExpPhase{2\pi w (z\times2^{k-1}+y)}\ket{z\ColorOne{y}} \\}
\Next{\Two}{&= \RootTwoN{k}\SumBV{v}{k} \ExpPhase{2\pi wv}\ket{v}
= \SS{k}}}
\only<19->{\QED{}}
\end{frame}
}
