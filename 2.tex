...
\begin{itemize}
    \item We can say $c$ controls whether the bottom output is a copy of $a$ or its complement.
    \item Or we can say $a$ controls whether the bottom output is a copy of $c$ or its complement.
