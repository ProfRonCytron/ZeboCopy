...
\begin{itemize}
    \item<1-> For an $n$-qubit problem, there are $2^{n-1}$ possible observed measurements, including \TensSupProd{0}{n}. This is because $\ket{w}$ is observable iff $\DotP{w}{s}=0$.
