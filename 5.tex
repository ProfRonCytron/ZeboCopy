...
\begin{itemize}
    ...
    \item<3-> The measurement outcomes and their liklihoods are:
    \begin{description}
...
\begin{itemize}
    ...
    \item We can demonstrate their usefulness with a simple photon diagram like the ones we have seen before, but this one has a surprise.
\end{itemize}

\Vskip{-4em}\TwoUnequalColumns{0.50\textwidth}{0.50\textwidth}{%
\begin{itemize}
    \item 
This is the famous \href{https://en.wikipedia.org/wiki/Mach-Zehnder_interferometer}{Mach--Zehnder interferometer}.  Based on what we've seen so far, a photon should be able to reach either measuring device.

  \item Surprisingly, only the \textcolor{orange}{device on the right} can ever receive a photon.

\item The explanation requires understanding phase and interference.
\end{itemize}
}{%
\begin{center}
