...
\Vskip{-2em}\begin{itemize}
    ...
    \item
    We can also see the top component is rotated by $\pi/2$ radians.  The superpositions measured \textcolor{orange}{by this device} each experienced one beam-splitter bend.}
\end{itemize}
}{%
\begin{center}
