...
\begin{itemize}
    \item Suppose the beam splitter is presented with a photon in superposition
\end{itemize}
}{%
\Vskip{-4em}\begin{center}
\begin{TIKZP}[scale=2.5]
\visible<1->{\RotateAroundCenter{-45}{\BeamSplitter{}}}
    \visible<1,5->{\draw[->,color=red] (0,0.5) node[left] {$\alpha$} node[midway,above] {\ket{0}} -- ++(0.5,0);}
    \visible<2,5->{\draw[->,color=brown] (0.5,1) node[above] {$\beta$} -- node[midway,right] {\ket{1}} ++(0, -0.5);}
    \visible<4,5-{\draw[->,color=NavyBlue] (0.5,0.5) -- ++(0,-0.5);}
    \visible<3,5->{\draw[->,color=orange] (0.5,0.5) -- (1.0,0.5);}
