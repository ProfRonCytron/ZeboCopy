...
\begin{frame}{Achieving rotation with no bomb prewsent}{The Bloch sphere and the physical rotation of a polarizing filter}
...
\begin{frame}{State analysis}{How likely are we to blow up?}
\end{frame}
