...
\only<15>{%
\MedSkip{}
We will arrange things so that after $n$ rotations we either will see \ket{0} if the bomb package is there, or \ket{1} if it is absent.  And each time through the package, we will have a predictably low chance of blowing up.
}
\end{frame}
