...
\lstick{\QZero{}} & \qw\slice{\alert<2>{\QState{0}}} &  \gate{H}\slice{\alert<3-5>{\QState{1}}} & \gate[wires=2][5em]{\mbox{$U_f$}}\gateinput{$x$}\gateoutput{$x$}\slice{\alert<6-8>{\QState{2}}} &\gate{H}\slice{\alert<9-10>{\QState{3}}} & \meter{\textcolor<8->{red}{\alt<25>{0}{0/1}}} \\
...
Suppose $f(0)=f(1)$.  \only<25>{Then the top qubit at \QState{2} is \ket{+}.  Measuring at \QState{3} yields \ket{0}.}
}{%
