...
\begin{center}
\Vskip{-3em}\adjustbox{valign=t}{\begin{quantikz}
...
\begin{align*}
    ...
    \only<9-10>{U_{f}(\ket{01}) &= \ket{0\,\Xor{0}{f(1)}} \\}
    \only<10-11>{U_{f}(\ket{10}) &= \ket{1\,\Xor{1}{f(0)}} \\}
...
\begin{align*}
    \visible<6->{\QState{2} &= U_f(\frac{1}{2}\left[\ket{00}-\ket{01}+\ket{10}-\ket{11}\right]) \\[1em]}
       \visible<7->{ &= \frac{%
        \alt<14->{\ket{0\,f(0)}}{\alt<9->{\ket{0\,\Xor{0}{f(0)}}}{U_f(\ket{00})}}-\alt<15->{\ket{0\,f(1)}}{\alt<10->{\ket{0\,\Xor{0}{f(1)}}}{U_f(\ket{01})}}}{2} \\ & + \frac{\alt<11->{\ket{1\,\Xor{1}{f(0)}}}{U_f(\ket{10})}-\alt<12->{\ket{1\,\Xor{1}{f(1)}}}{U_f(\ket{11})}}{2}}
\end{align*}
}
