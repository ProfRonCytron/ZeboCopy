...
\TwoColumns{%
\adjustbox{valign=t}{\begin{quantikz}
\lstick{\QZero{}} & \qw \slice{\alert<1>{\QState{0}}} &  \gate{H}\slice{\alert<2-5>{\QState{1}}} & \gate[wires=2][5em]{\mbox{$U_f$}}\gateinput{$x$}\gateoutput{$x$}\slice{\alert<7-8>{\QState{2}}} & \meter{\textcolor<8->{red}{0/1}}\\
\lstick{\QZero{}} & \gate{X} &   \gate{H}   &  \qw\gateinput{$y$}\gateoutput{\Xor{y}{f(x)}}  & \meter{\textcolor<8->{red}{0/1}}
\end{quantikz}}%
}{%
}
