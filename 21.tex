...
\Vskip{-2em}\begin{align*}
    \only<6-7>{\QState{2} &= U_f(\frac{1}{2}\left[\ket{00}-\ket{01}+\ket{10}-\ket{11}\right]) \\[1em]}
     \only<7->{\visible<8->{\QState{2}}   &= \frac{%
        \alt<14->{\ket{0\,f(0)}}{\alt<9->{\ket{0\,\Xor{0}{f(0)}}}{U_f(\ket{00})}}-\alt<16->{\ket{0\,\Not{f(0)}}}{\alt<10->{\ket{0\,\Xor{1}{f(0)}}}{U_f(\ket{01})}}  + \alt<15->{\ket{1\,f(1)}}{\alt<11->{\ket{1\,\Xor{0}{f(1)}}}{U_f(\ket{10})}}-\alt<17->{\ket{1\,\Not{f(1)}}}{\alt<12->{\ket{1\,\Xor{1}{f(1)}}}{U_f(\ket{11})}}}{2}}
\end{align*}}
\only<18-20>{%
\begin{itemize}
...
Suppose $f(0)=f(1)$.  \only<25>{Then the top qubit at \QState{2} is \ket{+}.  Measuring at \QState{3} yields \alert{\ket{0}}.}
}{%
\Vskip{-4em}\begin{align*}
    2\times\QState{2} &= \ket{0\,f(0)} - \ket{0\,\Not{f(0)}} + \ket{1\,\alert<21>{f(0)}} - \ket{1\,\Not{\alert<21>{f(0)}}} \\
  \visible<22->{  & = \TensProd{(\ket{0}+\ket{1})}{f(0)} - \TensProd{(\ket{0}+\ket{1})}{\Not{f(0)}} \\}
  \visible<23->{  & = \TensProd{(\ket{0}+\ket{1})}{(f(0)-\Not{f(0)})} \\}
  \visible<24->{ \QState{2} &= \TensProd{\ket{+}}{(f(0)-\Not{f(0)})\frac{1}{\sqrt{2}}} }
\end{align*}
}
}
\only<26->{%
\TwoUnequalColumns{0.3\textwidth}{0.7\textwidth}{%
Suppose $f(0) = \Not{f(1)}$.  \only<30>{Then the top qubit at \QState{2} is \ket{-}.  Measuring at \QState{3} yields \alert{\ket{1}}.}
}{%
\Vskip{-4em}\begin{align*}
    2\times\QState{2} &= \ket{0\,f(0)} - \ket{0\,\alert<26>{f(1)}} + \ket{1\,f(0)} - \ket{1\,\alert<26>{f(0)}} \\
  \visible<27->{  & = \TensProd{(\ket{0}-\ket{1})}{f(0)} - \TensProd{(\ket{0}-\ket{1})}{f(1)} \\}
  \visible<28->{  & = \TensProd{(\ket{0}-\ket{1})}{(f(0)-f(1))} \\}
  \visible<29->{ \QState{2} &= \TensProd{\ket{-}}{(f(0)-f(1))\frac{1}{\sqrt{2}}} }
\end{align*}
}
}
