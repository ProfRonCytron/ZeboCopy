...
\Vskip{-4em}\begin{align*}
  ...
  \visible<23->{  & = \TensProd{\textcolor<23-24>{\RCone}{(\ket{0}+\ket{1})}}{\textcolor<23-24>{\RCtwo}{(f(0)-\Not{f(0)})}} \\}
  \visible<24->{ \QState{2} &= \TensProd{\textcolor<24>{\RCone}{\ket{+}}}{\textcolor<24>{\RCtwo}{(f(0)-\Not{f(0)})\frac{1}{\sqrt{2}}}} }
\end{align*}
}
}
\only<26-30>{%
...
\Vskip{-4em}\begin{align*}
  ...
  \visible<28->{  & = \TensProd{\textcolor<28-29>{\RCone}{(\ket{0}-\ket{1})}}{\textcolor<28-29>{\RCtwo}{(f(0)-f(1))}} \\}
  \visible<29->{ \QState{2} &= \TensProd{\textcolor<29>{\RCone}{\ket{-}}}{\textcolor<29>{\RCtwo}{(f(0)-f(1))\frac{1}{\sqrt{2}}}} }
\end{align*}
}
}
\only<31->{%
