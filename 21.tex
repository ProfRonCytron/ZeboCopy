...
\Vskip{-2em}\begin{itemize}[<+->]
  ...
  \item We note here that the presence of \ket{-} as input for $y$ on the bottom qubit has the effect of changing phase on the \textcolor{\RCone}{\emph{top} qubit's} value on output:
  \begin{description}
