...
\draw<1-2>[->,thick] (0,0) -- (1,0) node[right] {\ \ket{0}};
\draw<1->[->,thick] (0,0) -- (0,1) node[above] {\ket{1}};
\draw<2->[->,thick,\Orange] (0,0) -- (22.5:1) node[above right] {\stackbox[l]{Bob \\ Alice should agree}};
\draw<2>[->,thick,dotted,\Orange] (0,0) -- (112.5:1) node[above] { };
\draw<3->[->,thick,\Red] (0,0) -- (0:1) node[right] {Alice};
\draw<4->[->,thick,\Yellow] (0,0) -- (45:1) node[above left] {Alice};
\end{TIKZP}
\end{center}}
