...
\item<2-> \TensSupProd{\Hadamard}{n}\ket{\TensSupProd{0}{n}} provides the correct result, because \Implies{w=0^n}{\Forall{v}{\DotP{v}{w}=0}}.
\item<3-> We can use this formula to compute \QState{3}.
\end{itemize}
\end{frame}
