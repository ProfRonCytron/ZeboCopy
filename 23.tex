...
\only<1-8,10->{
\begin{align*}
   \visible<1->{ \ColorOne{\sqrt{2^{\alt<1>{n}{3}}}}\QState{2} &= \ColorOne{\SumBV{w}{\alt<1>{n}{3}}} \ColorThree{\alt<1-4>{\NegF{w}}{\NegOneExp{0}}} \ColorOne{\ket{w}} \\}
...
\begin{itemize}
    ...
    \item<12-> It is helpful to view $f(x)$ as determining the sign $\pm 1$ of each term.
\end{itemize}
}
}{%
\begin{align*}
