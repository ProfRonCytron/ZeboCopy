...
\item<2-> \TensSupProd{\Hadamard}{n}\ket{\alert{\TensSupProd{0}{n}}} provides the correct result, because \Implies{w=0^n}{\Forall{v}{\ColorTwo{\DotP{\ColorThree{v}}{w}=0}}}.
...
\Vskip{-2em}\only<5->{\Vskip{-3em}}\begin{align*}
    \visible<2->{\ColorOne{\sqrt{2^n}} \QState{3} & = \ColorThree{\TensSupProd{\Hadamard}{n}}
       ...
       \ColorThree{\SumBV{v}{n} \NegOneExp{\DotP{v}{\ColorOne{w}}} \ket{v}} \\
       }
       \only<6->{%
    \visible<6,7->{   & = 
...
\begin{frame}{Deutsch--Josza}{Putting it all together}
