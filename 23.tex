...
\only<1-8,10->{
\begin{align*}
   \visible<1->{ \QState{2} &= \ColorOne{\SumBV{w}{\alt<1>{n}{3}}} \ColorThree{\alt<1-4>{\NegF{w}}{\NegOneExp{0}}} \ColorOne{\ket{w}} \\}
...
\only<10->{%
\begin{itemize}
    \item It's going to take some analysis to prove how a balanced $f(x)$ measures after \QState{3}.
\end{itemize}
}
}{%
\begin{align*}
   \visible<1->{ \QState{2} &= \ColorOne{\SumBV{w}{\alt<1>{n}{3}}} \ColorThree{\alt<1>{\NegF{w}}{\NegOneExp{1}}} \ColorOne{\ket{w}} \\}
