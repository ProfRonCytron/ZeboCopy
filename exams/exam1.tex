...
There are 108 points available for this exam, but it will only be scored out of 100.  Extra points earned here will count toward your total exam grade, including Exam~II.
...
\TFMarked{\textbf{x}}{\relax} or \TFMarked{\relax}{\textbf{x}}.  Each is worth 2 points, so there are 4 points of extra credit here.
...
\begin{itemize}
    ...
    \item For all states $\psi$, $\Gate{X}\Gate{Y}\psi\equiv\Gate{Y}\Gate{X}\psi$~\TF{}
       \item Following the measurement of a single qubit, the number of possible states of that qubit is uncountably infinite.~\TF{}
...
\begin{itemize}
    ...
    \item After a quantum bit is measured in the \X{} basis, suppose it is then measured in the standard (\Z{}) basis. The probability of measuring \ket{0} is \Blank{} and the probability of measuring \ket{1} is \Blank{}.
...
\item \Points{6} Either Express \ket{\QState{2}} as the product of two 1-quibit states:
...
\begin{itemize}
    ...
    \item \vline height 2em width0pt We return to the North pole.
