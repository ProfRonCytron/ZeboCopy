...
\begin{itemize}
    ...
    \end{center}
   \item For each scenario below, what is the most precise statement you can make about \ket{\psi}'s location on the Bloch sphere?
   \begin{itemize}
       \item 
...
\LeaveSpace{0.5in}
\item\Points{5} How could Alice and Bob use this information to tell that Eve
...
We can measure quantum states in any basis we choose.  In this problem, we measure the state of a 2-qubit quantum system in the \Gate{Bell} basis.  That basis is named and defined below:
\begin{center}
    \begin{tabular}{ccc}
