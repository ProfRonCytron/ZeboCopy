...
\Blank[20em]{}
\item In the table above, in which column(s) would Bob need to disagree with Alice to indicate that Eve might be present?  List all that are applicable.
...
\end{pmatrix*}
\]
\item The \NamedGate{SWAP} gate exchanges the position of two qubits and is described \href{https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.SwapGate}{here}. Prove that 
\[
