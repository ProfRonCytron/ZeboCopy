...
Your proof below:
\LeaveSpace{2in}
If Alice and Bob begin in state \ket{\psi_{1}}, does that entanglement follow them into \ket{\psi_{2}}, after any unitary~$U$ is applied to each qubit, so that their measurements consistently and perfectly disagree?\Blank{}
...
\GenTable{0}{1}
\item\Points{5} How does this differ from the situation in \ket{\psi_{1}}, before Eve joined?
\LeaveSpace{0.5in}
