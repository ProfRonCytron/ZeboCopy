...
\begin{enumerate}
    ...
    \LeaveSpace{1.5in}
    \item My oracle is suitable for use at least for the followings algorithm we have studied this semester: \Blank[4in]{}
...
\item\Points{6} OK the pontificator concedes, you are right\footnote{At least, Cytron hopes you got this right; sadly, he was not invited to this party}, but for all other values of $s$, the Bernstein--Vazirani functions provide \emph{all} oracles that are balanced to Deutsch--Jozsa: there are no others.
