...
\begin{itemize}
    \item Consider the oracle portion of a circuit below for an $8$-bit instance of the Bernstein--Vazirani problem.
    
    \includegraphics[scale=0.8]{bv.png}
    
    What is the secret $s$ here? \Blank{}
\end{itemize}
