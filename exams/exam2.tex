...
\begin{enumerate}
    ...
    \item From $\ket{\psi_{f}}$ what is the secret \ket{w} (which input value is special here)?\Blank{}
...
\clearpage\item\Points{5} You are at a party where everybody is talking about is quantum computing.  You overhear somebody pontificating about Bernstein--Vazirani problems of $n$ bits, namely functions of the form
\( f(x) = x \cdot s \),
