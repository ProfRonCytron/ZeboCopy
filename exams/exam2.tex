...
During an iteration of Grover, and after the first step (reflection) but before the second step (diffusion), we have (approximately) obtained the following state:
\[
...
\begin{enumerate}
    \item This is an instance of Grover for a function domain of \Blank{} bits.
    \item What is the secret \ket{w}?\Blank{}
    \item This is the first step of the \Blank{} iteration of the algorithm.
    \item When we complete the first step by performing diffusion, the resulting state will become:
    \[
\ket{\psi_{f}} = \begin{pmatrix*}[r]
   \Blank{} \\
   \Blank{} \\
