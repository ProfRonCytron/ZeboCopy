...
\begin{enumerate}[label=\theenumi.\arabic*]
  ...
  \LeaveSpace{}
  \item Based on our studies, what is the best way to reset a syndrome qubit back to \QZero{} after its measurement has been taken?  Assume the syndrome qubit is qubit $\ket{s}$ and its measurement has been taken on classical bit $c$.  Below complete the circuit that ensure $\ket{s}$ is \QZero{}.  Do not describe your result in words!  If you are answering this question on a medium other than this exam, replicate the circuit.
