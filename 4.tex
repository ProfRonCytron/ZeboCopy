...
\Vskip{-3em}\begin{itemize}
    ...
    \item<3-> What happens the photons strike a filter, coming at you from the screen, as shown here?
...
\TwoColumns{%
\begin{itemize}
    \item<1-> Start with unpolarized light heading into the screen.
...
\begin{itemize}
    ...
    \item<7> Some light passes through and is polarized according to the \textcolor{NavyBlue}{last} filter. \ToDo{clip the arrows}
\end{itemize}
}{%
\begin{center}
\begin{TIKZP}
