...
\begin{itemize}
    ...
    \TensProd{\Set{\textcolor<10>{Purple}{\ZZ{}}, \ZZPO{8}, \textcolor<10>{Purple}{\ZZPO{4}}}}{\Set{\ZZNPO{8},\textcolor<10>{Purple}{\ZZ{}},\textcolor<10>{Purple}{\ZZPO{4}}}}.
    ...
    \item<11-> For 3 of the pairs, measurement is separated by $\pi/8$ radians. Alice and Bob then expect to see the same value $\cos^{2}(\pi/8)\approx 0.85$ of the time, unless Eve is present.
\end{itemize}
\end{EKey}
}
}{%
...
\visible<12->{%
When their bases differ, their published measurements can implicate Eve.
}
}
