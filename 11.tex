...
\begin{description}
    ...
    \item<7->[\DisAgree{}] Bases differ by $3\pi/8$ radians, expecting \emph{dis}agreement with probability~$\sim 0.85$.
\end{description}}
\only<10->{%
\begin{itemize}
    \item Here we contrived to succeed on 100\% of the \MetaAgree{} and \DisAgree{} cases, but we expect to be right only about 85\% of the time.
