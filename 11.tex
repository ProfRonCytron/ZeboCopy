...
\begin{center}
    ...
    Example & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 & 9 \\ \hline
         Alice basis & \ZZ{} & \V{2}{\ZZ{}} & \V{3}{\ZZ{}} & \V{4}{\ZZPO{8}} & \V{5}{\ZZPO{8}} & \V{6}{\ZZPO{8}} & \V{7}{\ZZPO{4}} & \V{8}{\ZZPO{4}} & \V{9}{\ZZPO{4}} \\
         Alice measures & $0$ & \V{2}{$1$} & \V{3}{$0$} & \V{4}{$1$} & \V{5}{$0$} & \V{6}{$1$} & \V{7}{$0$} & \V{8}{$1$} & \V{9}{$0$} \\
         Bob basis & \ZZNPO{8} & \V{2}{\ZZ{}} & \V{3}{\ZZPO{8}} &   \V{4}{\ZZNPO{8}} & \V{5}{\ZZ{}} & \V{6}{\ZZPO{8}} & \V{7}{\ZZNPO{8}} & \V{8}{\ZZ{}} & \V{9}{\ZZPO{8}} \\
         Bob measures &  $0$ & \V{2}{$1$} & \V{3}{$0$} & \V{4}{$0$} & \V{5}{$0$} & \V{6}{$1$} & \V{7}{$1$} & \V{8}{$1$} &  \V{9}{$0$} \\
...
\end{center}
\begin{description}
    \item<1->[\MetaAgree{}] blah
    \item<2->[\Agree{}] blah
    \item<7->[\DisAgree{}] blah
\end{description}
\end{EKey}
