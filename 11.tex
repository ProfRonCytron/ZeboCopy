...
\begin{itemize}
    ...
    \item<11-> For 3 of the pairs, measurement is separated by $\pi/8$ radians. While not guaranteed, Alice and Bob expect to see the same value $\cos^{2}(\pi/8)\approx 0.85$ of the time.
\end{itemize}
\end{EKey}
}
}{%
