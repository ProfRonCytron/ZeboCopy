...
\begin{center}
    ...
    State & \multicolumn{4}{|c}{Value Sent}  \\ \hline
    1     \\
    2     \\
    3
    \end{tabular}
...
\begin{itemize}
    ...
    \item<3-> Bob receives the state and then randomly decides to measure the state in \STD{} or \HDM{}.
    \begin{itemize}
        \item Half the time, he will agree with Alice's basis, and his measurement will yield the state Alice sent.
