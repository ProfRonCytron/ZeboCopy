...
% \begin{frame}{Deadlines in this course}{No late work is accepted}

% \begin{itemize}
%    \item In the first courses in our department, and perhaps in other introductory or lower-level courses at the university, you have probably experienced mechanisms to offer deadline flexibility, such as:
%    \begin{itemize}
%       \item Late coupons
%       \item Penalties for late work that is still accepted
%       \item Extra credit assignments to remediate missing grades
%    \end{itemize}
%    \item This is a senior-level course, closer to the real world than introductory courses
%    \item In this course, deadlines are firm.  You are given plenty of time to complete the assignments.  It is up to you to 
%    \begin{itemize}
%        \item balance your time
%        \item anticipate problems that may arise, especially as a deadline approaches
%        \item turn in your assignments following the submission requirements given with each assignment.
%    \end{itemize} 
% \end{itemize}
