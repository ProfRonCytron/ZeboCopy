...
\end{quote}
In love and appreciation, I dedicate this work to my wife, Betsy Cytron.  At this writing we have been married \number\numexpr\year-1989\relax~years, and she has been with me through good times and bad. We have watched and helped each other find happiness and satisfaction in our work, in our families, and in each other.  I am grateful and so fortunate to have such a partner in life.
\SmallSkip{}
...
\begin{itemize}
    ...
    \item A circuit such as the one shown below can have suprising consequences, which are not apparent from the circuit itself, but which are revealed in the mathematical analysis of the circuit.
...
\end{itemize}
\begin{center}
    \includegraphics[scale=0.25]{000/complicated.png}
\end{center}
