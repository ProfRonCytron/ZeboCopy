...
\begin{frame}{Updates in response to the survey}{Hopefully these are improvements}

\begin{itemize}
    \item Four late coupons are available.
    \begin{itemize}
        \item Each pushes a deadline another 24 hours later.
    ...
    \end{itemize}
    \item All assignments are worth 100 points and are expected to take about 90 minutes of your time.
...
\begin{itemize}
    ...
    \item Will you stay in this course? \LinkArrow{https://magic-8ball.com/}
