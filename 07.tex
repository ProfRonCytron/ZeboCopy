...
\Vskip{-3em}\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item The photon is measured after passing through the first beam splitter.  From there it reaches either the \textcolor{orange}{orange} sensor or the \textcolor{NavyBlue}{blue} sensor.
    \end{itemize}
    }
    \only<3-5>{%
    ...
    \begin{tabular}{lc}
       ...
       \textcolor{NavyBlue}{Blue sensor} & 25\%
     \end{tabular}
     \end{center}
    ...
    \begin{tabular}{lc}
       ...
       \textcolor{NavyBlue}{Blue sensor} & 0\%
     \end{tabular}
     \end{center}
...
\begin{itemize}
    ...
    \[
        \textcolor<8>{OrangeRed}{n}\left(\frac{\pi}{2\textcolor<8>{NavyBlue}{n}}\right)^{\textcolor<8>{NavyBlue}{2}} \visible<9->{= \frac{\pi^2}{4n}} \visible<10->{\leq \alert<11>{\frac{2.5}{n}}}
    \]
\end{itemize}
}{%
\begin{itemize}
  ...
  \item<8-> \only<8-10>{While the chance of some explosion grows \textcolor<8>{OrangeRed}{linearly with $n$}, the chance of a single explosion grows as \textcolor<8>{NavyBlue}{$1/n^2$}.} \only<11>{\alert{The chance of an explosion can be made \emph{arbitrarily small}.}}
\end{itemize}
}}
\end{frame}
