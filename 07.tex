...
\TwoColumns{%
Consider a one-qubit gate:
\begin{align*}
U =& \SQBG{}{\ColorOne{u_{0,0}}}{\ColorTwo{u_{0,1}}}{\ColorThree{u_{1,0}}}{\ColorFour{u_{1,1}}}\\
=& \ColorOne{u_{0,0}}\KetBra{0}{0} + \ColorTwo{u_{0,1}}\KetBra{0}{1} \\
& + \ColorThree{u_{1,0}}\KetBra{1}{0} + \ColorFour{u_{1,1}}\KetBra{1}{1}
\end{align*}
}{%
}
