...
\only<13->{%
\begin{itemize}
    \item<13-> Can quantum circuits be similarly created?
    \item<14-> For example, we will soon study the simple circuit that creates an entangled pair of qubits.  To spread the entanglement to other qubits, is a larger physical gate needed?
    
    \item<15-> It turns out we \emph{can} create an arbitrarily large number of entangled qubits using (a linear amount of) fixed-size circuitry.
