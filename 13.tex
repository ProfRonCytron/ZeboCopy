...
\begin{itemize}
    \item Any quantum system of $n$ qubits can theoretically be decomposed into the product of two-level matrices, each of size $2^{n}\times 2^{n}$.  Each such matrix acts on a single qubit under control from the other qubits.
