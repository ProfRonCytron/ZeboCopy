...
\def\Complex#1#2{\ensuremath{#1 + #2\relax i}}
...
\newenvironment{BlochSphere}[1][scale=1.0]{
    \bgroup
    \def\TZPoint##1##2##3{%
        \draw[fill=black] (##1) circle (0.7pt) node[##3] {##2} ;}
    ...
    \begin{tikzpicture}[tdplot_main_coords, #1]
        ...
        \draw[dashed, tdplot_rotated_coords, OliveGreen] (0,0,0) circle (1);
